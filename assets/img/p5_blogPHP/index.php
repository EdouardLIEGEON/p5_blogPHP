<?php include("nav.php") ?>
        <section class="page-section clearfix">
            <div class="container">
                <div class="intro">
                    <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="assets/img/code.jpg" alt="Screenshot d'un code" />
                    <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                        ...
                        <div class="intro-button mx-auto"><a class="btn btn-primary btn-xl" href="contact.php">Me contacter</a></div>
                    </div>
                </div>
            </div>
        </section>
